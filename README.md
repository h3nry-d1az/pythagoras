...
any SVG directly, and in such a way that transitioning into ${\rm \LaTeX}$ is
...
The API reference generated by Sphinx, is available at the
[GitHub page associated to this repo](https://h3nry-d1az.github.io/pythagoras/).

I have also uploaded [a YouTube video](https://youtu.be/UlX8bVKoGzg>) covering
the fundamental aspects of the library, which is a good resource from which get
started.
